# This Makefile is for the PGObject::Util::PGConfig extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/PGObject/Util/PGConfig.pm]
...
MAKE = make
FULLEXT = PGObject/Util/PGConfig
BASEEXT = PGConfig
PARENT_NAME = PGObject::Util
DLBASE = $(BASEEXT)
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/PGObject/Util/PGConfig.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)/PGObject/Util
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/PGObject/Util
...
TO_INST_PM = lib/PGObject/Util/PGConfig.pm

PM_TO_BLIB = lib/PGObject/Util/PGConfig.pm \
...
manifypods : pure_all  \
	lib/PGObject/Util/PGConfig.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/PGObject/Util/PGConfig.pm $(INST_MAN3DIR)/PGObject::Util::PGConfig.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''Postgres Configuration Management'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "Postgres Configuration Management",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Postgres Configuration Management</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/PGObject/Util/PGConfig.pm blib/lib/PGObject/Util/PGConfig.pm 
